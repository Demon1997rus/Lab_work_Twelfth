	...
	private void initialize() {
		...
		pbAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				interactionList.add(textFieldForAdd.getText());
				textArea.setText(interactionList.toStringForward());
			}
		});
		...
		pbDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(interactionList.delete(textFieldForDelete.getText())) {
					textArea.setText(interactionList.toStringForward() + "\nУдалить удалось");
				} else {
					textArea.setText(interactionList.toStringForward() + "\nУдалить не удалось");
				}
		...
		pbListViewBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.setText(interactionList.toStringBack());
			}
		});
		...
		pbSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(interactionList.find(textFieldForSearch.getText())) {
					textArea.setText(interactionList.toStringForward() + "\nСтрока найдена");
				} else {
					textArea.setText(interactionList.toStringForward() + "\nСтрока не найдена");
				}
